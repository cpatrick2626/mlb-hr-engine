"""
MLB HR Prop Betting Engine -- v3
=================================
Enhancements over v2:
  - Backtest framework: python backtest.py [days]
    Scores model vs actual HR outcomes, calibration table + P&L simulation
  - All v2 features: Statcast barrel%/exit velocity, HR/FB pitcher factor,
    real platoon splits, Statcast contact quality, P&L + CLV tracking

Run:  python main.py
      python backtest.py 14
"""
