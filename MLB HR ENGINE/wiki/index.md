...
| [Room Governance](doctrine/room-governance.md) | ChatGPT Project Manager / Command Center owns planning; Claude Code and Codex are bounded execution agents | Codex | updated 2026-09-12 |
...
| [Production Surface Truth](doctrine/production-surface-truth.md) | Root frontend/ on Vercel; mlb_hr_engine_v4/ is engine/backend; Fly is manual backend deployment | Codex | updated 2026-09-12 |
...
| [Build Log and Spec Status](doctrine/build-log-and-spec-status.md) | build history and current Graphify freshness correction | Codex | updated 2026-09-12 |
...
| [Deploy Runbook](doctrine/deploy-runbook.md) | Vercel frontend and manual Fly backend deployment truth | Codex | updated 2026-09-12 |
...
| [Local Evidence Register](doctrine/local-evidence-register.md) | PC-only and untracked evidence locations, authority classes, preservation and review status | Codex | updated 2026-09-12 |
