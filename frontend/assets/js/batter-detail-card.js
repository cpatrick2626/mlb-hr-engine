...
function BatterDetailCard({ row, onClose, onPitch, builderMode = false }) {
  ...
  const statTilesFull = [
    ...
    {k:"BARREL%",   v:fv(sc,"barrel",sc.barrel, pct),             p:"brl zone", tier:sc_tier(sc.barrel,15,8), top:sc.barrel>=15},
    ...
    {k:"PULL-AIR%", v:fv(sc,"pullair",sc.pullair,pct),            p:"pull+air",  tier:sc_tier(sc.pullair,20,12)},
  ...
  const statTilesHand = [
    ...
    {k:"BARREL%",   v:fv(sc,"barrel",   sc.barrel,     pct), p:"brl zone",   tier:sc_tier(sc.barrel,15,8)},
    {k:"xSLG",      v:fv(sc,"xslg",     sc.xslg,       fmtD),p:"expected",   tier:sc_tier(sc.xslg,.600,.480)},
    {k:"xISO",      v:fv(sc,"xiso",     sc.xiso,       fmtD),p:"xpower",     tier:sc_tier(sc.xiso,.280,.200)},
    {k:"PACE",      v:seasPace,                                p:"162g proj",  tier:sc_tier(threat.season_pace_hr,40,28)},
  ];
